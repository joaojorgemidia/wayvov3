            ...
            <thead>
              <tr className="border-b bg-muted/40">
                ...
                <th className="px-4 py-3.5 text-left text-xs font-semibold uppercase tracking-wider text-muted-foreground">
                  KM Atual <InfoTooltip text="Quilometragem atual registrada no hodômetro" />
                </th>
              ...
              {filtered.map((m) => {
                ...
                return (
                  <tr key={m.id} className="border-b last:border-0 transition-colors hover:bg-primary/[0.03]">
                    ...
                    <td className="px-4 py-3.5 font-mono text-foreground/80">{m.kmAtual != null ? `${m.kmAtual.toLocaleString("pt-BR")} Km` : "—"}</td>
                    <td className="px-4 py-3.5">
